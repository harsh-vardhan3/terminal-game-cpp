...
char Dungeon::menu()
{
	...
	if (!lightsOn)
	{
		...
		cout << "2. Go back to the HALL OF MOIRANG." << endl;
	...
	else
	{
		cout << endl;
		cout << "What would you like to do?" << endl;
		cout << "1. Talk to the PRINCESS THOIBI." << endl;
		cout << "2. Go back to the HALL OF MOIRANG." << endl;
		cout << "3. Manage Inventory." << endl;
		cout << "4. Quit Game." << endl;
		cout << endl;
...
void Dungeon::displayTag()
{
	...
	if (!lightsOn && !reqItemObt)
	{
		...
		cout << "PRINCESS THOIBI: Please, you have to help. Come back when you have a LIT-TORCH!" << endl;
	}
	...
	else if (!lightsOn)
	{
		...
		cout << "PRINCESS THOIBI: Quick, use your LIT-TORCH to illuminate the room" << endl;
	}
	//if the lights are on
	else
