...
void Game::play()
{
	...
	do
	{
		...
		{
			resetConsole();
			cout << "You hear the PRINCESS THOIBI shout out from the cursed prison:" << endl << endl;
			cout << "THOIBI: Please hurry! The water is up to my knees now!" << endl << endl;
			pause();
		}
		else if (waterLevel == 30)
		{
			resetConsole();
			cout << "You hear the PRINCESS THOIBI shout out from the cursed prison:" << endl << endl;
			cout << "THOIBI: Please hurry! The water is almost to my head!" << endl << endl;
			pause();
		}
...
void Game::specialLibrary()
{
	...
	{
		resetConsole();
		cout << "The MOIRANG BLADE is incased in thick glass, you're going to need something heavy to smash it..." << endl << endl;
		pause();
	}
	...
	else
	{
		...
		else
		{
			...
			cout << "ITEM OBTAINED: MOIRANG BLADE" << endl << endl;
...
void Game::specialDungeon()
{
	...
	{
		resetConsole();
		cout << "PRINCESS THOIBI: Oh thank goodness, you've found the CURSED PRISON KEY. Quick, set me free!" << endl << endl;
	...
	{
		resetConsole();
		cout << "PRINCESS THOIBI: Please, you have to help me. The storm is so bad that the PRISON is flooding..." << endl;
		cout << "          I don't have much time, you have to get the PRISON KEY to unlock my chains. The key lies" << endl;
		cout << "          up in the TOWER. You'll have to slay the dragon and remove the CURSED PRSION KEY from its stomach," << endl;
		...
		else
		{
			...
			cout << "PRINCESS THOIBI: Inside the secret room is an item that can protect you from the dragon's fire." << endl;
			cout << "          Now please hurry, slay the dragon and return with the PRISON KEY!" << endl << endl;
			pause();
		}
	}
	...
	{
		resetConsole();
		cout << "PRINCESS THOIBI: You have the GOLDEN-SHIELD and a weapon, what are you waiting for? Go slay" << endl;
	...
	{
		resetConsole();
		cout << "PRINCESS THOIBI: Great you found the GOLDEN-SHIELD. Now take whatever weapon you can find" << endl;
	...
	{
		resetConsole();
		cout << "PRINCESS THOIBI: Hurry, you have to retrieve the item from the LIBRARY secret room. Its the" << endl;
...
void Game::specialTower()
{
	...
	do
	{
		...
		if (searchInventory("HERO'S-SWORD"))
		{
			...
			{
				cout << "You barely clip the dragon with the BALDE OF MOIRANG" << endl << endl;
				dragonHealth -= 15;
			}
			else if (attack == 3)
			{
				cout << "You strike the dragon with the BLADE OF MOIRANG" << endl << endl;
				dragonHealth -= 25;
			}
			else
			{
				cout << "You deliver a devistating blow to the dragon with the BLADE OF MOIRANG!" << endl << endl;
				dragonHealth -= 50;
			}
		}
		else
		...
		else
		{
			...
			if (searchInventory("HEALTH-POTION"))
			{
				...
				if (choice == 1)
				{
					cout << "You drink the health potion...you feel like a whole new person!" << endl << endl;
					health += 30;
				}
			}
	...
	if (dragonDead)
	{
		...
		cout << "You slice into its stomach to retrieve the CURSED PRISON KEY" << endl << endl;
		...
		else
		{
			...
			cout << "ITEM OBTAINED: CURSED PRISON KEY" << endl << endl;
			cout << "Quick, we have to get to THOIBI before she drowns!" << endl << endl;
		}
		...
		if (choice == 1)
		{
			...
			if (!searchDiscardPile("KING'S-LETTER") && !searchInventory("KING'S-LETTER"))
			{
				...
				else
				{
					...
					cout << "in the CURSED PRISON and fed the key to a wicked beast in the tower. Please" << endl;
...
void Game::searchLibrary()
{
	...
	do
	{
		...
		if (choice == 1)
		{
			...
			{
				cout << "You find a GOLDEN IDOL!" << endl << endl;
				...
				else
				{
					...
					cout << "ITEM OBTAINED: GOLDEN IDOL" << endl << endl;
					pause();
				}
			}
			else
...
void Game::searchTreasury()
{
	...
	do
	{
		...
		else if (choice == 2)
		{
			...
			{
				cout << "There's too much treasure to possibly carry, but the MOIRANG RUBY catches your eye!" << endl << endl;
				...
				else
				{
					...
					cout << "ITEM OBTAINED: MOIRANG RUBY" << endl << endl;
					pause();
				}
			}
			else
		...
		else if (choice == 3)
		{
			...
			{
				cout << "There's too much treasure to possibly carry, but KING'S CUP catches your eye!" << endl << endl;
				...
				else
				{
					...
					cout << "ITEM OBTAINED: KING'S CUP" << endl << endl;
					pause();
				}
			}
			else
...
void Game::searchTower()
{
	...
	else
	{
		...
		{
			cout << "You retrieve the CURSED PRISON KEY from the dragon's stomach...Gross!" << endl << endl;
			inventory.push_back("DUNGEON-KEY");
			cout << "ITEM OBTAINED: CURSED PRISON-KEY" << endl << endl;
		}
	}
...
void Game::winScreen()
{
	...
	cout << "PRINCESS THOIBI: Thank you so much for saving me!" << endl;
